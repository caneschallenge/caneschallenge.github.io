                ...
                for (i in questions) {
                    if (questions.hasOwnProperty(i)) {
                        ...
                        if (plugin.config.disableResponseMessaging || plugin.config.completionResponseMessaging) {
                            ...
                            questionHTML.append('<a href="#" id="nextButton" onclick="resetSecondpassed();return false;" class="button ' + nextQuestionClass + '">' + plugin.config.nextQuestionText + '</a>');
                            questionHTML.append('<a href="#" id="submitAnswer" onclick="stopTimer();return false;" class="button ' + checkAnswerClass + '">' + plugin.config.checkAnswerText + '</a>');
                        }
